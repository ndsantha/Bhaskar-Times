...
<h1 class="fs-1 text-center mt-5">CRYPTO<b style="color:#B71C1C">CURRENCY</b></h1>
<div class="row">
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/bit.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Bitcoin Price Trend Signals Significant Increase Ahead of Halving</p>
    <a href="bit.html" class="btn view">Learn More</a>
  </div>
</div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/eth.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Ethereum Still Leads in Holdings Despite Bitcoin's Favorable Growth Outlook</p>
    <a href="eth.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/doge.png" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Elon Musk reveals why Dogecoin is his favorite cryptocurrency</p>
    <a href="doge.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
</div>
