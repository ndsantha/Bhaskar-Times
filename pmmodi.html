...
<h1 class="fs-1 text-center mt-5">PM<b style="color:#B71C1C"> MODI</b></h1>
<div class="row">
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/pm.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Just Like That | Language barrier: White man's ‘burden’, brown man's ‘ignorance’</p>
    <a href="pmmodi1.html" class="btn view">Learn More</a>
  </div>
</div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/pm2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">‘India emerged as a centre of global trust and attraction’: PM Modi at Rozgar Mela. Top quotes</p>
    <a href="pmmodi2.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
