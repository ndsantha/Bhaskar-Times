...
<h1 class="fs-1 text-center mt-5"><b style="color:#B71C1C">Cricket <i class="fa-solid fa-baseball-bat-ball"></i></b></h1>
<div class="row">
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/news7.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">'Dhoni always insists to know...': India A star reveals legend's advice ahead of Emerging Asia Cup final vs Pakistan A</p>
...
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/cricket1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">IND A vs PAK A Live, Emerging Asia Cup final: Tahir slams brilliant century</p>
    <a href="Cricket1.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/cricket2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">England vs Australia Ashes 4th Test Day 5 Live Score: Rain stands between Stokes-led ENG and win in Manchester</p>
    <a href="Cricket2.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
</div>
