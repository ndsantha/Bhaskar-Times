...
<h1 class="fs-1 text-center mt-5"><b style="color:#B71C1C"> SPORTS</b></h1>
<div class="row">
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/sports1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Jamaica hold France to a 0-0 draw in a surprising Women's World Cup opener</p>
    <a href="sports1.html" class="btn view">Learn More</a>
  </div>
</div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/sports2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Barcelona superstar says no to Cristiano Ronaldo, turns down Al-Nassr's staggering €200m offer</p>
    <a href="sports2.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/sports3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Netherlands keep Women's World Cup debutants Portugal quiet in 1-0 win</p>
    <a href="sports3.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
</div>
