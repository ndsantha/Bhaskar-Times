...
<h1 class="fs-1 text-center mt-5"><b style="color:#B71C1C">Politics</b></h1>
<div class="row">
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/poli1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">BJP, JD(S) boycott Assembly proceedings in protest against suspension of 10 MLAs</p>
    <a href="poli1.html" class="btn view">Learn More</a>
  </div>
</div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/poli2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">BJP is uncivilised & anti-democracy: Siddaramaiah on BJP MLAs’ conduct in Karnataka assembly</p>
    <a href="poli2.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/poli3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">PM Modi remembers Mukesh on 100th birth anniversary, Neil Nitin Mukesh reacts</p>
    <a href="poli3.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
</div>
