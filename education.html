...
<h1 class="fs-1 text-center mt-5"><b style="color:#B71C1C">EDUACATION</b></h1>
<div class="row">
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/education1.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">SSC Delhi Police, CAPF SI notification released, apply till August 15 on ssc.nic.in</p>
    <a href="education1.html" class="btn view">Learn More</a>
  </div>
</div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/education2.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">CSIR UGC NET Result 2023 Live: Final provisional answer key out</p>
    <a href="education2.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
<div class="col-sm-12 col-md-4 col-lg-4">
<div class="card" style="width: 18rem;">
  <img src="images/education3.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Can studying linguistics help tackle inequality?</p>
    <a href="education3.html" class="btn view">Learn More</a>
  </div>
  </div>
</div>
</div>
